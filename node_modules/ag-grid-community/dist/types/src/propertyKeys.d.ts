...
export declare const _NUMBER_GRID_OPTIONS: KeysOfType<number>[];
export declare const _BOOLEAN_MIXED_GRID_OPTIONS: KeysOfType<boolean>[];
export declare const _BOOLEAN_GRID_OPTIONS: KeysOfType<boolean>[];
