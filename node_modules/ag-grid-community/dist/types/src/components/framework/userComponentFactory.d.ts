...
export declare class UserComponentFactory extends BeanStub implements NamedBean {
    ...
    getCompDetailsFromGridOptions(type: ComponentType, defaultName: string | undefined, params: any, mandatory?: boolean): UserCompDetails | undefined;
    getCompDetails<TDefinition, TComp extends IComponent<any>>(defObject: TDefinition, type: ComponentType, defaultName: string | undefined, params: any, mandatory?: boolean): UserCompDetails<TComp> | undefined;
    private newAgStackInstance;
    /**
     * merges params with application provided params
     * used by Floating Filter
     */
    mergeParams<TDefinition>(defObject: TDefinition, type: ComponentType, paramsFromGrid: any, paramsFromSelector?: any, defaultCompParams?: any): any;
}
