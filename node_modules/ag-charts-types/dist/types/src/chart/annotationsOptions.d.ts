...
export interface AgFibonacciRetracementAnnotation extends AnnotationLinePoints, Extendable, Lockable, Visible, StrokeOptions, LineOptions, AgFibonacciAnnotationStyles {
...
export type AgAnnotationsToolbarButtonValue = 'line-menu' | 'fibonacci-menu' | 'text-menu' | 'shape-menu' | 'measurer-menu' | 'line' | 'horizontal-line' | 'vertical-line' | 'parallel-channel' | 'disjoint-channel' | 'fibonacci-retracement' | 'text' | 'comment' | 'callout' | 'note' | 'clear';
