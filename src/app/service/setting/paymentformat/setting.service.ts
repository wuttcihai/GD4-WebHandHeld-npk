...
export class PaymentFormatService {
  ...
  getPaymentFormat(): Observable<DeviceResponse> {
    return this.http.get<DeviceResponse>(`${this.apiUrl}/setting/paymentformat/all`).pipe(
      shareReplay(1),
  ...
  deletePaymentFormat(resultData: any): Observable<DeviceResponse> {
    return this.http.delete<DeviceResponse>(`${this.apiUrl}/setting/paymentformat/delete`, {
