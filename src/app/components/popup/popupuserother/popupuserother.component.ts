...
@Component({
  selector: 'app-popupuserother',
  standalone: false,

  templateUrl: './popupuserother.component.html',
  styleUrl: './popupuserother.component.scss'
})
export class PopupuserotherComponent implements OnInit {
  ...
  constructor
    ...
    public data: any,
      private ref: MatDialogRef<PopupuserotherComponent>,
  ...
  okClick() {
    let resData = { "username": this.Username, "password": this.Password }
